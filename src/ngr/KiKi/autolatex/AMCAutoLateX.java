...
import ngr.KiKi.autolatex.views.FormulaPanel;
import ngr.KiKi.autolatex.views.QuestionRenderer;

/**
 *
 * @author KiKi
 */
public class AMCAutoLateX extends javax.swing.JFrame
{
	...
	private void init ()
	{
		...
		for (int i = 0; i < 15; i++)
			questions.add (new Question ("Quelle est la couleur du cheval blanc d'Henry IV ? C'est la question ultime", Question.TYPE.OPEN));
	...
	private void initQuestions ()
	{
		...
		for (int i = 0; i < questions.size (); i++)
		{
			...
			jPanelQuestionsList.add (new QuestionRenderer (this, q, i + 1), new CC ().wrap ().growX ());
		}
	}
    ...
    private void initComponents()
    {
        ...
        jScrollPane3.setBorder(javax.swing.BorderFactory.createTitledBorder("Intitulé"));

        jTextArea2.setColumns(20);
        jTextArea2.setRows(5);
        jScrollPane3.setViewportView(jTextArea2);

        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("Réponses"));
	...
	public static void main (String args[])
	{
		...
		{
			java.util.logging.Logger.getLogger (AMCAutoLateX.class.getName ()).log (java.util.logging.Level.SEVERE, null, ex);
		}
		...
		{
			new AMCAutoLateX ().setVisible (true);
		});
	}
